...
Smart contract creation, development, and deployment on TON Blockchain leverages the [FunC programming language](/v3/documentation/smart-contracts/overview#func-language) and [TON Virtual Machine (TVM)](/v3/documentation/smart-contracts/overview#ton-virtual-machine).
...
Revamped low-level language for TON smart contracts made as replacement for FunC.
...
* [MyLocalTON](/v3/guidelines/nodes/running-nodes/running-a-local-ton) — run a private TON Blockchain in your local environment.
* [tonwhales.com/tools/boc](https://tonwhales.com/tools/boc) — BOC parser
* [TS Example of BoC parse](https://github.com/memearchivarius/UnpackBoC) - simple data extraction
...
* [Understanding Transaction Fees](/v3/documentation/smart-contracts/transaction-fees/fees#how-to-calculate-fees)
